...
public class newpassword1 extends AppCompatActivity {
    ...
    Button confirmpass;
    String password,cpassword,name,status,message,url = config.baseurl+"newpass1.php";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_newpassword1);
        newpassword = findViewById(R.id.newpassword1);
        confirm = findViewById(R.id.confirm1);
        confirmpass = findViewById(R.id.confirmpass11);
    ...
    private void newPassword() {
        ...
        StringRequest stringRequest =  new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if ("1".equals(status)) {
                    Toast.makeText(newpassword1.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(newpassword1.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Nullable
