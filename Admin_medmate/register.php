    ...
    <div class="container">
        <div class="card mt-4">
            <div class="card-header bg-primary text-white">
                <h3><i class="bi bi-person-plus-fill"></i> User Registration List</h3>
            </div>
            <div class="card-body">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>
                                            <form method='POST' action='' style='display:inline;' class='d-inline'>
                                                ...
                                                <button type='submit' name='delete_doctor' class='btn btn-danger action-btn' onclick='return confirm(\"Are you sure you want to delete this user?\");'>
